...
import type { CourseExtended } from '../../../interfaces';
...
function RouteComponent() {
      ...
      <div className="flex justify-center items-center min-h-screen bg-slate-300">
        <div className="text-center">
          <h2 className="text-2xl font-semibold mb-4">
            You must be logged in to view the course syllabus.
          </h2>
  ...
  const { courseName, professor } = courseData;
        ...
        <header className="flex items-start justify-between gap-6">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600">
              Instructor: {professor?.fullName ?? 'N/A'} · Spring 2026 · Tue/Thu
              10:30-11:50 AM · Room 204
            </p>
          </div>
          ...
          <main className="lg:col-span-3 space-y-6">
            <section className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <article className="rounded-lg bg-white border border-gray-200 p-4 shadow-sm">
                ...
                <p className="mt-2 text-sm text-gray-600">
                  Build robust, scalable full-stack web applications with modern
                  tooling. Emphasis on TypeScript, testing, deployment, and
            ...
            <section className="rounded-lg bg-white border border-gray-200 p-6 shadow-sm">
              ...
              <ul className="mt-4 space-y-3 text-sm text-gray-700">
                <li>
                  <strong>Late work:</strong> Acceptable up to 48 hours with 10%
                  penalty per day unless prior arrangement.
                </li>
                <li>
                  <strong>Academic integrity:</strong> Collaboration encouraged
                  on design; code must be your own. Violations reported to the
                  honor council.
                </li>
                <li>
            ...
            <footer className="text-xs text-gray-500">
              <p>
                This syllabus is a sample and subject to change. Official dates
                and deadlines will be posted on the course site; always refer to
                the course site for the authoritative schedule.
              </p>
            </footer>
          </main>
        </div>
